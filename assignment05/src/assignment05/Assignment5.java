...
public class Assignment5 {
	...
	/**
	 * PROBLEM 3 Similar to PROBLEM 1. Leaving it as an exercise
	 * 
	 * @param args
	 */

	/**
	 * PROBLEM 4 Evaluates expressions passed as a string in the prefix form. We
	 * need to keep one stack for storing operators and another for operands, so
	 * we can just use the TwoStack class.
	 * 
	 * @param args
	 */
	public double evaluate(String expression) {
		...
		return Double.parseDouble((String) twoStack.popSecond()); // pop from
																	// the
																	// operand
																	// stack
	}
