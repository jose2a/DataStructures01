...
import insertionsorttest.*;
import insertionsorttest.main.Main;
...
public class ShellSorter {
	...
	/**
	 * In the main method, I have also compared the times between shell sort and
	 * insertion sort algorithm. On my system, Shell Sort took about 95 millis
	 * to sort 100,000 records, while insertion sort takes about over 18 seconds
	 * to do the same. You may want to play with it yourself and see how fast
	 * Shell Sort really is.
	 */
	public static void main(String[] args) {
		...
		// make another copy of the array, so that we can use regular
		// InsertionSort algo over it
		...
		Main.insertionSort(data2); // InsertionSort was implemented
											// earlier, calling it to compare
											// with Shell Sort
